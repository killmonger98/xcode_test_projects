...
//  NamesList
//
//  Created by Abhiram Krishna on 18/12/20.
//
...
class ViewController: UIViewController {
    ...
    // NSManagedObject - base class that implements the behavior required of a Core Data model object
    ...
    func save(name: String) {
        ...
        // NSEntityDescription - description of an entity in Core Data
        let entity =
